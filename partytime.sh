...
# # echo $J
echo start
while ! /opt/Autodesk/wiretap/tools/current/wiretap_get_metadata -h $bbmmanager:Backburner -n /servergroups/dummy01 -s info > /nfs/chwumbo/home/ryan/Desktop/partyTime10.xml
do
  sleep 1
  printf "wait"
  /opt/Autodesk/wiretap/tools/current/wiretap_get_metadata -h $bbmmanager:Backburner -n /servergroups/dummy01 -s info > /nfs/chwumbo/home/ryan/Desktop/partyTime10.xml
done

printf "\n complete"

# /opt/Autodesk/wiretap/tools/current/wiretap_get_metadata -h $bbmmanager:Backburner -n /servergroups/dummy01 -s info > /nfs/chwumbo/home/ryan/Desktop/partyTime7.xml
...
#   /opt/Autodesk/wiretap/tools/current/wiretap_get_metadata -h $bbmmanager:Backburner -n /servergroups/$individualGroup -s info > /nfs/chwumbo/home/ryan/Desktop/partyTime.xml
#
#   deleteTag=false
#   onlyOne=false
#
...
#     newData=$updated
#     # echo $newData > /tmp/log.txt
#   else
#     echo youarehere
#     echo $rawData > /nfs/chwumbo/home/ryan/Desktop/rawData2.txt
#
#     newData=$(xmlstarlet fo -t - <<<"$rawData")
#     echo $newData > /nfs/chwumbo/home/ryan/Desktop/newData3.txt
...
#     # echo "new:" $newData
#     echo $finalXML
#     echo $newData $updatedServerGroupAttributes finalXML $finalXML> /nfs/chwumbo/home/ryan/Desktop/log10.txt
#
#
#   fi
#
